 ...
 *
 * To run this on the Selenium tests XML files,
 * click "Edit Configuration" in IDEA and change its classpath to be jira-selenium-tests instead of jira-func-tests
 */
