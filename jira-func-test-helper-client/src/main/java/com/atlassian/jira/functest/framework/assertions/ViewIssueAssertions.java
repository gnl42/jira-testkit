...
public class ViewIssueAssertions extends AbstractFuncTestUtil
{
    ...
    {
        assertFalse(new IdLocator(tester, "components-val").exists());
    }

    public void assertFixVersionAbsent()
    {
        assertFalse(new IdLocator(tester, "fixfor-val").exists());
    }

    public void assertAffectsVersionAbsent()
    {
        assertFalse(new IdLocator(tester, "versions-val").exists());
    }
}
