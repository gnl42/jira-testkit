        ...
        if (table.getColumnCount() > 1)
        {
            ...
            for (int j = 1; j < table.getRowCount(); j++)
            {
                ...
                for (int i = 0; i < columns.size(); i++)
                {
                    ...
                    else if (col.equals("Issues"))
                    {
                        issues = parseIssues(cell);
                    }
                ...
                filterItems.add(new FilterItem(id, name, description, author, issues, sharing, isFav, subscriptions, operations, favCount));
            }
        }
        else
        {
