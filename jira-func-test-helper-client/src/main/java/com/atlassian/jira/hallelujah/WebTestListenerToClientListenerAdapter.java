...
import com.atlassian.buildeng.hallelujah.listener.AbstractClientListener;
...
public class WebTestListenerToClientListenerAdapter extends AbstractClientListener implements ClientListener
{
    ...
    {
        listener.testFailure(fromTestCaseName(result.testCaseName), new Exception(result.failure.message));
        listener.testFinished(fromTestCaseName(result.testCaseName));
        return true;
    }
    ...
    {
        listener.testError(fromTestCaseName(result.testCaseName), new Exception(result.error.message));
        listener.testFinished(fromTestCaseName(result.testCaseName));
        return true;
    }
