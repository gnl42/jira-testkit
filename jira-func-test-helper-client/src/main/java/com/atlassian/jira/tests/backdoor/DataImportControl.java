...
public class DataImportControl extends BackdoorControl<DataImportControl>
{
    ...
    {
        restoreDataFromResource("blankprojects.xml");
    }
     ...
     * about the working directory the test process is running in. Use {@link #restoreDataFromResource(String)}
    ...
    {
        return com.atlassian.jira.tests.backdoor.RestoreDataResources.getResourceUrl(resourcePath).getFile();
    }
