...
import com.atlassian.jira.tests.util.dbc.NumberAssertions;
...
import static com.atlassian.jira.tests.util.dbc.NumberAssertions.greaterThan;
...
public class CompositeClock implements Clock
{
    ...
    {
        NumberAssertions.greaterThan("startFromCall", startFromCall, clocks.lastKey());
