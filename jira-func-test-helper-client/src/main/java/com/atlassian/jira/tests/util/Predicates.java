...
public class Predicates
{
    ...
    {
        com.atlassian.jira.tests.util.dbc.Assertions.notNull("check", check);
    ...
    {
        com.atlassian.jira.tests.util.dbc.Assertions.notNull("clazz", clazz);
        return new Predicate<T>()
        {
            public boolean evaluate(final T input)
            {
    ...
    {
        return new NotPredicate<T>(com.atlassian.jira.tests.util.dbc.Assertions.notNull("predicate", predicate));
    }
    ...
    public static abstract class Composite<T> implements Predicate<T>
    {
        ...
        {
            this.left = com.atlassian.jira.tests.util.dbc.Assertions.notNull("left", left);
            this.right = com.atlassian.jira.tests.util.dbc.Assertions.notNull("right", right);
        }
    }
