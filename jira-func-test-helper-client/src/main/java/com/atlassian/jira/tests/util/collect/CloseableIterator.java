...
import static com.atlassian.jira.tests.util.collect.CloseableIterator.Functions.foreach;

import com.atlassian.jira.tests.util.Closeable;
...
public interface CloseableIterator<E> extends Iterator<E>, Closeable
{
    ...
    public class ListResolver<T>
    {
        ...
        public List<T> get(final CloseableIterator<T> it)
        {
            ...
            foreach(it, new com.atlassian.jira.tests.util.Consumer<T>()
            {
    ...
    {
        public static <T> void foreach(final CloseableIterator<T> iterator, final com.atlassian.jira.tests.util.Consumer<T> consumer)
        {
            try
            {
