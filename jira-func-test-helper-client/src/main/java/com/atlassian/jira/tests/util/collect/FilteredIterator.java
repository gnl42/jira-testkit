...
class FilteredIterator<T> implements Iterator<T>
{
     ...
     */
    FilteredIterator(@com.atlassian.jira.tests.util.NotNull final Iterator<T> iterator, @com.atlassian.jira.tests.util.NotNull final Predicate<? super T> predicate)
    {
