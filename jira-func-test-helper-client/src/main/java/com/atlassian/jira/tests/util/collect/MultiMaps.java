...
import com.atlassian.jira.tests.util.Supplier;
...
{
    public static <K, V, C extends Collection<V>> MultiMap<K, V, C> create(final Map<K, C> basedOn, final com.atlassian.jira.tests.util.Supplier<C> collectionFactory)
    {
        return new MMap<K, V, C>(basedOn, collectionFactory);
    }

    public static <K, V, C extends Collection<V>> MultiMap<K, V, C> create(final com.atlassian.jira.tests.util.Supplier<C> collectionFactory)
    {
    ...
    static class MMap<K, V, C extends Collection<V>> extends AbstractMap<K, C> implements MultiMap<K, V, C>
    {
        ...
        private final com.atlassian.jira.tests.util.Supplier<C> collectionFactory;

        public MMap(final Map<K, C> delegate, final com.atlassian.jira.tests.util.Supplier<C> collectionFactory)
        {
