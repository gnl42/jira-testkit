...
public class Transformed
{
    ...
    public static <I, E> com.atlassian.jira.tests.util.collect.EnclosedIterable<E> enclosedIterable(final com.atlassian.jira.tests.util.collect.EnclosedIterable<I> iterable, final Function<I, E> transformer)
    {
        return new com.atlassian.jira.tests.util.collect.TransformingIterable<I, E>(iterable, transformer);
    }
    ...
    {
        return new com.atlassian.jira.tests.util.collect.TransformingIterator<I, E>(set, transformer);
    }
