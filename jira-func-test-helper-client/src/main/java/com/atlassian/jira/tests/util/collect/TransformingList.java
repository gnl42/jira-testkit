 ...
 * of type I and uses a {@link com.atlassian.jira.tests.util.Function} that converts those I into a V.
 * <p>
...
class TransformingList<I, E> extends AbstractList<E>
{
    ...
    private final com.atlassian.jira.tests.util.Function<I, E> transformer;

    TransformingList(@com.atlassian.jira.tests.util.NotNull final List<? extends I> collection, @com.atlassian.jira.tests.util.NotNull final com.atlassian.jira.tests.util.Function<I, E> transformer)
    {
