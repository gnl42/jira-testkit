...
import static com.atlassian.jira.tests.util.collect.Transformed.entry;
import static com.atlassian.jira.tests.util.collect.Transformed.set;
...
class TransformingMap<K, V, I> extends AbstractMap<K, V>
{
    ...
    TransformingMap(@com.atlassian.jira.tests.util.NotNull final Map<K, I> map, @com.atlassian.jira.tests.util.NotNull final Function<I, V> transformer)
    {
    ...
    static class DecoratedEntry<K, I, V> implements Map.Entry<K, V>
    {
        ...
        DecoratedEntry(@com.atlassian.jira.tests.util.NotNull final Entry<? extends K, ? extends I> entry, @com.atlassian.jira.tests.util.NotNull final Function<I, V> transformer)
        {
