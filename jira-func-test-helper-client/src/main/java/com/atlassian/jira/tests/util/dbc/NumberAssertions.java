...
import com.atlassian.jira.tests.util.lang.JiraStringUtils;

import static com.atlassian.jira.tests.util.lang.JiraStringUtils.asString;
...
public final class NumberAssertions
{
    ...
    public static int equal(String name, int actual, int expected)
    {
        if (actual != expected)
        {
            throw new IllegalArgumentException(
					JiraStringUtils.asString(name, " is: <", actual, ">, must be equal to <", expected, ">"));
        }
        return actual;
    }
    ...
    public static int greaterThan(String name, int actual, int floor)
    {
        ...
        {
            throw new IllegalArgumentException(
					JiraStringUtils.asString(name, " is: <", actual, ">, must be greater than <", floor, ">"));
        }
        return actual;
    }
    ...
    public static int lessThan(String name, int actual, int ceiling)
    {
        ...
        {
            throw new IllegalArgumentException(
					JiraStringUtils.asString(name, " is: <", actual, ">, must be less than <", ceiling, ">"));
        }
        return actual;
    }
    ...
    public static int greaterThanOrEqual(String name, int actual, int floor)
    {
        ...
        {
            throw new IllegalArgumentException(
					JiraStringUtils.asString(name, " is: <", actual, ">, must be greater than or equal <", floor, ">"));
        }
        return actual;
    }
    ...
    public static int lessThanOrEqual(String name, int actual, int ceiling)
    {
        ...
        {
            throw new IllegalArgumentException(
					JiraStringUtils.asString(name, " is: <", actual, ">, must be less than or equal <", ceiling, ">"));
        }
        return actual;
    }
