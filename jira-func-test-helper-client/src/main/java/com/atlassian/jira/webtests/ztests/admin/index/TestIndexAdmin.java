...
public class TestIndexAdmin extends JIRAWebTest
{
    ...
    public void testReindexAsSystemAdmin()
    {
        ...
        assertTextPresent("Please note that performing a re-index will cause JIRA to be unavailable to all users until the re-index has completed.");
        executeReindex();
    }


    /** Make sure that an admin cannot change the index path. */
    ...
    public void testReindexAsNormalAdmin()
    {
        ...
        assertTextPresent("Only a user with the System Administrator Global Permission can modify the search index path.");
    ...
    private void executeReindex()
    {
        ...
        // We should also be able to see the optimize index page
        clickLinkWithText("Optimise Indexes");
        assertTextPresent("To optimise the indexes please click 'Optimise'");
    }
