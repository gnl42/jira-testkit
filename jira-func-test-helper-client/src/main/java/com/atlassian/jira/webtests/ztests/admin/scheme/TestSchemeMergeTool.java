...
public class TestSchemeMergeTool extends JIRAWebTest
{
    ...
    public void testPermissionSchemesCanMerge() throws SAXException
    {
        try
        {
            ...
            // Now lets go off to the project page and make sure that the association was correctly changed.
            gotoPage("/plugins/servlet/project-config/HSP/permissions");
            assertions.assertNodeByIdHasText("project-config-header-name", PROJECT_HOMOSAP);
            assertions.assertNodeByIdHasText("project-config-permissions-scheme-name", "New_Scheme_1");
    ...
    public void testNotificationSchemesCanMerge() throws SAXException
    {
        try
        {
            ...
            assertions.assertNodeByIdHasText("project-config-header-name", PROJECT_HOMOSAP);
            assertions.assertNodeByIdHasText("project-config-notification-scheme-name", "New_Scheme_1");
        }
        finally
        {
            HttpUnitOptions.setScriptingEnabled(false);
