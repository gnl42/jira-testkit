...
public class TestBulkEditIssues extends BulkChangeIssues
{
    ...
    public void _testBulkEditOneIssueInCurrentPage()
    {
        ...
        assertions.getURLAssertions().assertCurrentURLEndsWith("/secure/IssueNavigator.jspa");
    ...
    public void testBulkEditSessionTimeouts()
    {
        ...
        tester.beginAt("secure/views/bulkedit/BulkEditDetailsValidation.jspa");
        verifyAtSessionTimeoutPage();
    }
    ...
    private void verifyAtSessionTimeoutPage()
    {
        text.assertTextPresent
                (
                        ...
                        "Your session timed out while you were in the process of selecting issues to perform a bulk operation on."
                );
    }
