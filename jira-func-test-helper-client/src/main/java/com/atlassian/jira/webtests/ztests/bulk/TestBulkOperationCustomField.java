...
{
    private static final String TABLE_EDITFIELDS_ID = "editfields";
    ...
    public void testBulkEdit()
    {
        ...
        checkCheckbox("all", "on");
        submit("Next");
        checkCheckbox(FIELD_OPERATION, RADIO_OPERATION_EDIT);
        assertRadioOptionSelected(FIELD_OPERATION, RADIO_OPERATION_EDIT);
        HttpUnitOptions.setScriptingEnabled(false);//turn script off so the unavailable actions table is displayed
        submit("Next");
    ...
    public void testBulkTransition()
    {
        ...
        checkCheckbox("wftransition", "jira_5_5"); //resolve issue
        submit("Next");
