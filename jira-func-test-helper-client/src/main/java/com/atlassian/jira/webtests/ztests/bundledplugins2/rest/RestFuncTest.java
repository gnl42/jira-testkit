...
public abstract class RestFuncTest extends FuncTestCase
{
    ...
    {
        List<String> pathsNoLeadingSlashes = Lists.transform(Arrays.asList(paths), new Function<String, String>()
        {
            @Override
        ...
        String path = pathsNoLeadingSlashes != null ? StringUtils.join(pathsNoLeadingSlashes, '/') : "";
