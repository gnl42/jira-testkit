...
import com.atlassian.jira.webtests.ztests.bundledplugins2.rest.client.DashboardClient;
...
public class TestDashboardResource extends RestFuncTest
{
    ...
    public void testDashboardResourceShouldAllowGettingFavouriteDashboards() throws Exception
    {
        ...
        assertThat(page0.next(), equalTo(getRestApiUri("/dashboard?startAt=2&filter=favourite&maxResults=" + PAGE_SIZE).toString()));
        ...
        assertThat(page1.prev(), equalTo(getRestApiUri("/dashboard?startAt=0&filter=favourite&maxResults=" + PAGE_SIZE).toString()));
