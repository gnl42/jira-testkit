...
import com.atlassian.jira.webtests.ztests.bundledplugins2.rest.client.OperationalUpdateRequest;
...
public class TestIssueResourceCustomFields extends RestFuncTest
{
    ...
    public void testProject() throws Exception
    {
        ...
        assertEquals(getBaseUrl() + "/rest/api/2/project/MKY", projectPicker.get("self"));
