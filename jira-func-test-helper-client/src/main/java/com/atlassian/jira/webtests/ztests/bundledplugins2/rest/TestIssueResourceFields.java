...
import com.atlassian.jira.webtests.ztests.bundledplugins2.rest.client.Progress;
...
public class TestIssueResourceFields extends RestFuncTest
{
    ...
    private void checkPriority(final Issue.Fields fields)
    {
        ...
        assertEquals(getBaseUrl() + "/images/icons/priority_major.gif", priority.iconUrl());
    ...
    private void checkProject(final Issue.Fields fields)
    {
        ...
        final Map<String, String> avatarUrls = MapBuilder.<String, String>newBuilder()
                .add("16x16", getBaseUrl() + "/secure/projectavatar?size=small&pid=10000&avatarId=10011")
                .add("48x48", getBaseUrl() + "/secure/projectavatar?pid=10000&avatarId=10011")
                .toMap();
        assertEquals(avatarUrls, project.avatarUrls);
    }
    ...
    private void checkAssignee(final Issue.Fields fields)
    {
        ...
        final Map<String, String> avatarUrls = MapBuilder.<String, String>newBuilder()
                .add("16x16", getBaseUrl() + "/secure/useravatar?size=small&avatarId=10062")
                .add("48x48", getBaseUrl() + "/secure/useravatar?avatarId=10062")
                .toMap();
    ...
    private void checkStatus(final Issue.Fields fields)
    {
        ...
        assertEquals(getBaseUrl() + "/images/icons/status_resolved.gif", status.iconUrl());
    }
