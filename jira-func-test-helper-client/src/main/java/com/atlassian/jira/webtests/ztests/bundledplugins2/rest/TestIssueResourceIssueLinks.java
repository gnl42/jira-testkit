...
import static com.atlassian.jira.webtests.ztests.bundledplugins2.rest.client.LinkRequest.FIELD_NAME;
                ...
                new IssueLink.IssueLinkRef()
                        ...
                        .fields(new IssueLink.IssueLinkRef.Fields()
                                ...
                                .issueType(new IssueType().id("1")
                                        ...
                                        .iconUrl(getBaseUrlPlus("/images/icons/bug.gif")))
                                .status(new Status().id("1")
                                        .name("Open")
                                        .self(getRestApiUrl("/status/1"))
                                        .description("The issue is open and ready for the assignee to start work on it.")
                                        .iconUrl(getBaseUrlPlus("/images/icons/status_open.gif")))
                                .priority(new Priority().id("3")
                                        .name("Major")
                                        .self(getRestApiUrl("/priority/3"))
                                        .iconUrl(getBaseUrlPlus("/images/icons/priority_major.gif")))
                        )
        )));
    }
