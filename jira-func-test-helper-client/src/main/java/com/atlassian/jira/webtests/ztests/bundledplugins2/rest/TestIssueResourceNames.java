...
import static com.atlassian.jira.webtests.ztests.bundledplugins2.rest.client.Issue.Expand;
...
public class TestIssueResourceNames extends FuncTestCase
{
    ...
    public void testIssueRepresentationShouldContainExpandableNamesField() throws Exception
    {
        ...
        assertThat(minimal.expand, containsString(Expand.names.name()));

        Issue expanded = issueClient.get("HSP-1", Expand.names);
