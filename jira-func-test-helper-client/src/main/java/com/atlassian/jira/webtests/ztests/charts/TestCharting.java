...
public class TestCharting extends FuncTestCase
{
    ...
    public void testCreatedVsResolvedReport()
    {
        ...
        CssLocator locator = new CssLocator(tester, "#content");
        ...
        locator = new CssLocator(tester, "#content");
        text.assertTextPresent(new CssLocator(tester, "#content header h1"), "Created vs Resolved Issues Report");
        text.assertTextSequence(new CssLocator(tester, "#content .content-body .reportHeading h3"), "homosapien");
    ...
    public void testPieReport()
    {
        ...
        CssLocator locator = new CssLocator(tester, "#content");
        text.assertTextPresent(new CssLocator(tester, "#content header h1"), "Pie Chart Report");
    ...
    public void testAverageAgeReport()
    {
        ...
        text.assertTextPresent(new CssLocator(tester, "#content header h1"), name);
        text.assertTextSequence(new CssLocator(tester, "#content .content-body .reportHeading h3"), "homosapien");
    ...
    private void assertReportValidation(String url, String reportName, String noIssuesMsg)
    {
        ...
        WebPageLocator locator = new WebPageLocator(tester);
        text.assertTextPresent(new CssLocator(tester, "#content header h1"), reportName);
        text.assertTextSequence(new CssLocator(tester, "#content .content-body .reportHeading h3"), "homosapien");
