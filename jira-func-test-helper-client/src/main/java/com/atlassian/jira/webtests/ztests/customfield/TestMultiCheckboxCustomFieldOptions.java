...
public class TestMultiCheckboxCustomFieldOptions extends JIRAWebTest
{
    ...
    public void testDisabledValidForSearch() throws SAXException
    {
        ...
        // Check selectList values
        assertTrue(locator.id("searcher-" + CUSTOMFIELD_LONG_ID + "-1").exists());
        assertTrue(locator.id("searcher-" + CUSTOMFIELD_LONG_ID + "-2").exists());
        assertTrue(locator.id("searcher-" + CUSTOMFIELD_LONG_ID + "-3").exists());
        assertTrue(locator.id("searcher-" + CUSTOMFIELD_LONG_ID + "-4").exists());
    }
