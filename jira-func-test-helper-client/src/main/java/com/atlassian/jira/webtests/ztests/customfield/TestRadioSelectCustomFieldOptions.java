...
public class TestRadioSelectCustomFieldOptions extends JIRAWebTest
{
    ...
    public void testDisabledValidForSearch() throws SAXException
    {
        ...
        // Check radio buttons present
        assertTrue(locator.id("searcher-" + CUSTOMFIELD_LONG_ID + "_1").exists());
        assertTrue(locator.id("searcher-" + CUSTOMFIELD_LONG_ID + "_2").exists());
        assertTrue(locator.id("searcher-" + CUSTOMFIELD_LONG_ID + "_3").exists());
    }
