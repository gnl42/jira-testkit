...
//        assertLinkPresentWithText(FIELD_SCHEME_NAME);
    ...
    public void checkNavigatorFields()
    {
        ...
        assertTextInElement("issue-filter", "Assignee");
        assertTextInElement("issue-filter", "Due Date");
        assertTextInElement("issue-filter", "Priorities");
        assertTextInElement("issue-filter", "Resolution");
        ...
        getNavigation().issueNavigator().displayAllIssues();
        setWorkingForm("issue-filter");
        assertTextNotInElement("issue-filter","Assignee");
        assertTextNotInElement("issue-filter", "Due Date");
        assertTextNotInElement("issue-filter", "Priorities");
        assertTextNotInElement("issue-filter", "Resolution");
