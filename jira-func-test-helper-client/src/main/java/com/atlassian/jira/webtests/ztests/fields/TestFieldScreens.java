...
public class TestFieldScreens extends JIRAWebTest
{
    ...
    private void fieldScreensAddFieldToFieldScreenWithInvalidPosition()
    {
        ...
        tester.assertTextPresent("Invalid field position.");
    }
    ...
    private void fieldScreensCopyScreen()
    {
        ...
        tester.clickLink("configure_fieldscreen_" + ASSIGN_FIELD_SCREEN_NAME);
...
//        assertLinkPresent("edit_fieldscreenscheme_" + CREATE_ISSUE_OPERATION_SCREEN);
     ...
     protected void fieldScreensTabViews()
    {
        ...
        text.assertTextPresent(locator.xpath("//ul[@id=\"tabCellPane1\"]/li[1]//strong"), CUSTOM_FIELD_NAME_TWO);
        text.assertTextPresent(locator.xpath("//ul[@id=\"tabCellPane1\"]/li[1]//div[@class='wrap']/div"), "High");

        text.assertTextPresent(locator.xpath("//ul[@id=\"tabCellPane2\"]/li[1]//strong"), CUSTOM_FIELD_NAME);
        text.assertTextPresent(locator.xpath("//ul[@id=\"tabCellPane2\"]/li[1]//div[@class='wrap']/div"), "Rhino");
        ...
        text.assertTextPresent(locator.xpath("//ul[@id=\"tabCellPane1\"]/li[1]//strong"), CUSTOM_FIELD_NAME_TWO);
        text.assertTextPresent(locator.xpath("//ul[@id=\"tabCellPane1\"]/li[1]//div[@class='wrap']/div"), "Low");

        text.assertTextPresent(locator.xpath("//ul[@id=\"tabCellPane2\"]/li[1]//strong"), CUSTOM_FIELD_NAME);
        text.assertTextPresent(locator.xpath("//ul[@id=\"tabCellPane2\"]/li[1]//div[@class='wrap']/div"), "Tiger");
