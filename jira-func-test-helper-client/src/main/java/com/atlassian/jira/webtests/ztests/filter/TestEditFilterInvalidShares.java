...
public class TestEditFilterInvalidShares extends FuncTestCase
{
    ...
    public void testEditFilterRemoveGroup()
    {
        ...
        navigation.issueNavigator().loadFilter(GROUP_FILTER_ID, null);
        tester.clickLink(EDITSHARES_LINK_ID);
        ...
        assertSearchEditCorrectly(GROUP_FILTER_INFO, SHARE_SEARCH, Collections.<TestSharingPermission>emptySet());
    }
    ...
    public void testEditFilterRemoveBrowse()
    {
        ...
        navigation.issueNavigator().loadFilter(PROJECT_FILTER_ID, null);
        tester.clickLink(EDITSHARES_LINK_ID);
        ...
        assertSearchEditCorrectly(PROJECT_FILTER_INFO, SHARE_SEARCH, pub);
    }
    ...
    public void testEditFilterRemoveRole()
    {
        ...
        navigation.issueNavigator().loadFilter(ROLE_FILTER_ID, null);
        tester.clickLink(EDITSHARES_LINK_ID);
    ...
    public void testEditFilterGlobalShareRemove()
    {
        ...
        navigation.issueNavigator().loadFilter(REMOVE_FILTER_ID, null);
        tester.clickLink(EDITSHARES_LINK_ID);
    ...
    public void testEditFilterMultipleProblems()
    {
        ...
        navigation.issueNavigator().loadFilter(MULTIPLE_FILTER_ID, null);
        tester.clickLink(EDITSHARES_LINK_ID);
        ...
        assertSearchEditCorrectly(MULTIPLE_FILTER_INFO, SHARE_SEARCH, new HashSet<TestSharingPermission>(shares));
    }
     ...
     */
    private void assertSearchEditCorrectly(final SharedEntityInfo info, final NavigatorSearch expectedSearch,
