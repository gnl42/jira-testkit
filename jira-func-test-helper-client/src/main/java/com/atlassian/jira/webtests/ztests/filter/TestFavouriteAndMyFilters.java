...
public class TestFavouriteAndMyFilters extends FuncTestCase
{
    ...
    private void checkAnonymousScreen(List /*<FilterItems>*/ expectedFilters)
    {
        ...
        text.assertTextPresent(locator.css(".content-related > .vertical.tabs"), "Search");
        text.assertTextPresent(locator.css(".content-related > .vertical.tabs"), "Popular");
        text.assertTextNotPresent(locator.css(".content-related > .vertical.tabs"), "Favourite");
        text.assertTextNotPresent(locator.css(".content-related > .vertical.tabs"), "My");
