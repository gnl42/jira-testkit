...
public class TestLabelsFormats extends FuncTestCase
{
    ...
    public void testBulkOperations()
    {
        ...
        tester.clickButton("Next");

        tester.setFormElement("operation", "bulk.edit.operation.name");
        tester.clickButton("Next");
        navigation.gotoPage("/secure/BulkEditDetailsValidation.jspa?actions=labels&actions=customfield_10000&" + createUrlString(LABELS_FIELD, EXPECTED_LABELS) + "&" + createUrlString(EPIC_FIELD, EXPECTED_EPICS));
