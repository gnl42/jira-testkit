...
public class TestNextPreviousPager extends FuncTestCase
{
    ...
    public void testPager()
    {
        ...
        text.assertTextPresent(locator, "Issue Navigator \u2014 No Issues");
        text.assertTextPresent(locator, "No matching issues found.");
        ...
        locator = new WebPageLocator(tester);
        text.assertTextPresent(locator, "Issue Navigator \u2014 11 Issues");
        text.assertTextPresent(locator, "Displaying issues 1 to 11 of 11 matching issues.");
