...
public class TestMoveIssueForEnterprise extends JIRAWebTest
{
    ...
    private void createWorkflowWithDifferentWorkflows()
    {
        ...
        assignWorkflowScheme("10001", "Bug", WORKFLOW_COPIED);
        assignWorkflowScheme("10001", "New Feature", WORKFLOW_COPIED);
        assignWorkflowScheme("10001", "Task", WORKFLOW_COPIED);
        assignWorkflowScheme("10001", "Improvement", WORKFLOW_ADDED); //this issue type has a different workflow with different statuses
