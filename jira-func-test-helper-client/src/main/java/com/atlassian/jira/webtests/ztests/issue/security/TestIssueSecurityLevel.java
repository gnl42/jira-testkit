...
public class TestIssueSecurityLevel extends FuncTestCase
{
    ...
    public void testIssueNavigatorVisibility()
    {
        ...
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "PIG-15", "Visible to All Project Leads", "Mahatma Gandhi", "Mark", "", "Open", "Unresolved", "20/Jan/11", "20/Jan/11", ""}));        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-47", "Cowboys and Admins", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-46", "Any User (project role)", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-44", "Friendly Users - Bill included", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-41", "Friendly Group - Cowboy Group", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-40", "Security Level Project Lead", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-39", "Security Level Bill User", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-37", "Issue Assigned to Bill", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-36", "Issue added by Bill.", "Henry Ford", "Wild Bill Hickock", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-35", "Milk the jersey", "Henry Ford", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-34", "Get along little doggy", "Henry Ford", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
    ...
    public void testIssueNavigatorVisibility_User_Gandhi()
    {
        ...
        final ExpectedTable expectedTable = new ExpectedTable();
        expectedTable.appendRow(new ExpectedRow(new String[] {"T", "Key", "Summary", "Assignee", "Reporter", "P", "Status", "Resolution", "Created", "Updated", "Due"}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "PIG-15", "Visible to All Project Leads", "Mahatma Gandhi", "Mark", "", "Open", "Unresolved", "20/Jan/11", "20/Jan/11", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-48", "Reporters and Developers - not reported by Bill", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-46", "Any User (project role)", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-45", "Friendly Users - Bill not included", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-44", "Friendly Users - Bill included", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-43", "Friendly Group - jira-developers Group", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-36", "Issue added by Bill.", "Henry Ford", "Wild Bill Hickock", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-35", "Milk the jersey", "Henry Ford", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-34", "Get along little doggy", "Henry Ford", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        tester.assertTableEquals("issuetable", expectedTable);
    ...
    /**
     * The IssueSecurityLevelManager caches results for a User/Project combination.
    ...
    {
        // TODO: Write this test when we fix  	 JRA-14323
        // TODO: Also test the list of levels in the drop-down on create issue and edit issue.
    ...
    public void testProjectLeadVIsibility() throws Exception
    {
        ...
        expectedTable.appendRow(new ExpectedRow(new String[] {"T", "Key", "Summary", "Assignee", "Reporter", "P", "Status", "Resolution", "Created", "Updated", "Due"}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "PIG-15", "Visible to All Project Leads", "Mahatma Gandhi", "Mark", "", "Open", "Unresolved", "20/Jan/11", "20/Jan/11", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "LEO-1", "Only Visible to Joe", "Murray", "Mark", "", "Open", "Unresolved", "20/Jan/11", "20/Jan/11", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-46", "Any User (project role)", "Wild Bill Hickock", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-35", "Milk the jersey", "Henry Ford", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        expectedTable.appendRow(new ExpectedRow(new String[] {"", "COW-34", "Get along little doggy", "Henry Ford", "Mark", "", "Open", "Unresolved", "08/Jul/08", "08/Jul/08", ""}));
        tester.assertTableEquals("issuetable", expectedTable);
