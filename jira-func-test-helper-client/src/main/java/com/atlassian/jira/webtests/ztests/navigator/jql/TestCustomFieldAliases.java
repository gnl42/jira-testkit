...
public class TestCustomFieldAliases extends AbstractJqlFuncTest
{
    ...
    {
        navigation.issueNavigator().createSearch("SameDiffSame ~ 1");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The operator '~' is not supported by the 'SameDiffSame' field.");

        navigation.issueNavigator().createSearch("SameDiffSame = 1");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The operator '=' is not supported by the 'SameDiffSame' field.");

        navigation.issueNavigator().createSearch("SameDiffSame = 2");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The operator '=' is not supported by the 'SameDiffSame' field.");

        navigation.issueNavigator().createSearch("SameDiffSame ~ Value1");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The operator '~' is not supported by the 'SameDiffSame' field.");
    ...
    public void testSameNameSameTypeSameContextDifferentValues() throws Exception
    {
        ...
        assertFitsFilterForm("SelectHidden = \"SameValue\"");
        assertSearchWithResults("SelectHidden = \"DiffValue1\"", "HSP-8");
        assertFitsFilterForm("SelectHidden = \"DiffValue1\"");
        
        navigation.issueNavigator().createSearch("SelectHidden = \"DiffValue2\"");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The option 'DiffValue2' for field 'SelectHidden' does not exist.");
        ...
        navigation.issueNavigator().createSearch("\"Select\" = \"DiffValue1\"");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The option 'DiffValue1' for field 'Select' does not exist.");
        navigation.issueNavigator().createSearch("\"Select\" = \"DiffValue2\"");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The option 'DiffValue2' for field 'Select' does not exist.");
    }
    ...
    public void testSameNameSameTypeDiffContext() throws Exception
    {
        ...
        assertFitsFilterForm("SelectContext = 'Option1' and project = homosapien", createFilterFormParam("pid","10000"), createFilterFormParam("customfield_10040","10010"));
        assertSearchWithResults("SelectContext = 'Option1' and project = monkey", "MKY-1");
        assertFitsFilterForm("SelectContext = 'Option1' and project = monkey", createFilterFormParam("pid","10001"), createFilterFormParam("customfield_10041","10013"));
    ...
    public void testSameNameDiffTypeSameOperator() throws Exception
    {
        ...
        assertTooComplex("cf[10050] = \"New Version 1\"");
