...
public class TestQueryTooComplex extends FuncTestCase
{
    ...
    public void testNewAdvancedSearchTooComplex() throws Exception
    {
        ...
        navigation.issueNavigator().createSearch(reallyBloodyLongQuery);
        assertions.getIssueNavigatorAssertions().assertJqlErrors("One of the clauses in your search matches too many results. If a clause returns too many results, the entire search will fail. Please try refining or removing the clauses in your search and run it again.");
    }
    ...
    public void testSavedFilterTooComplex() throws Exception
    {
        ...
        text.assertTextPresent(new XPathLocator(tester, "//tr[@id='mf_10000']"), "Too Complex");
    ...
    public void testChangeHistoryJqlTooComplex() throws Exception
      {
          administration.restoreBlankInstance();
          navigation.issueNavigator().createSearch(statusjQlQuery);
