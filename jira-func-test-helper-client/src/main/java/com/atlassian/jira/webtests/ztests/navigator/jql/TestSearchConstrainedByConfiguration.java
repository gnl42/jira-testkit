...
public class TestSearchConstrainedByConfiguration extends AbstractJqlFuncTest
{
    ...
    public void testNoBrowseProjectPermission() throws Exception
    {
        ...
        assertions.getIssueNavigatorAssertions().assertJqlErrors("Field 'Cascading Select CF' does not exist or you do not have permission to view it.");
    }
    ...
    public void testValidValuesBasedOnBrowseProjectPermission() throws Exception
    {
        ...
        assertEquals(IssueNavigatorNavigation.NavigatorMode.SUMMARY, navigation.issueNavigator().getCurrentMode());
        tester.clickLink("editfilter");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("A value with ID '10001' does not exist for the field 'project'.");
        ...
        assertEquals(IssueNavigatorNavigation.NavigatorMode.SUMMARY, navigation.issueNavigator().getCurrentMode());
        tester.clickLink("editfilter");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("A value with ID '10001' does not exist for the field 'Project Picker CF'.");
    ...
    public void testValidValuesForParentClause() throws Exception
    {
        ...
        assertSearchWithError(createJqlQuery("parent", "HSP-1", "MKY-1"), "An issue with key 'MKY-1' does not exist for field 'parent'.");
        tester.gotoPage("/secure/IssueNavigator.jspa?mode=hide&requestId=10037");
        assertEquals(IssueNavigatorNavigation.NavigatorMode.SUMMARY, navigation.issueNavigator().getCurrentMode());
        tester.clickLink("editfilter");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("A value with ID '10001' does not exist for the field 'parent'.");
    }
    ...
    private void _runFilterAndVerifySearchRestricted(final int filterId, final String fieldName, final String invalidValue)
    {
        ...
        assertEquals(IssueNavigatorNavigation.NavigatorMode.SUMMARY, navigation.issueNavigator().getCurrentMode());
        tester.clickLink("editfilter");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The value '"+invalidValue+"' does not exist for the field '"+fieldName+"'.");
    }
    ...
    private void _runFilterAndVerifyFieldDoesntExist(final String field, final int filterId)
    {
        ...
        assertEquals(IssueNavigatorNavigation.NavigatorMode.SUMMARY, navigation.issueNavigator().getCurrentMode());
        tester.clickLink("editfilter");
        assertions.getIssueNavigatorAssertions().assertJqlErrors("Field '"+field+"' does not exist or you do not have permission to view it.");
    }
}
