...
public class TestSystemFieldDoesItFitSingle extends AbstractJqlFuncTest
{
    ...
    {
        assertFitsFilterForm("comment ~ ccc", createFilterFormParam("query", "ccc"), createFilterFormParam("body", "true"), createFilterFormParam("summary", (String[]) null), createFilterFormParam("environment", (String[]) null), createFilterFormParam("description", (String[]) null));
    ...
    {
        assertFitsFilterForm("description ~ ccc", createFilterFormParam("query", "ccc"), createFilterFormParam("body", (String[]) null), createFilterFormParam("summary", (String[]) null), createFilterFormParam("environment", (String[]) null), createFilterFormParam("description", "true"));
    ...
    {
        assertFitsFilterForm("environment ~ ccc", createFilterFormParam("query", "ccc"), createFilterFormParam("body", (String[]) null), createFilterFormParam("summary", (String[]) null), createFilterFormParam("environment", "true"), createFilterFormParam("description", (String[]) null));
    ...
    {
        assertFitsFilterForm("summary ~ ccc", createFilterFormParam("query", "ccc"), createFilterFormParam("body", (String[]) null), createFilterFormParam("summary", "true"), createFilterFormParam("environment", (String[]) null), createFilterFormParam("description", (String[]) null));
