...
public class TestUserQueriesCaseInsensitive extends AbstractJqlFuncTest
{
    ...
    {
        assertions.assertNodeByIdEquals("header-details-user-fullname", "Administrator from LDAP");
        log("Running queries with (pseudo) LDAP directory first");
        runUserQueries();
        swapDirectories();
        assertions.assertNodeByIdEquals("header-details-user-fullname", "Administrator in the Shadows");
