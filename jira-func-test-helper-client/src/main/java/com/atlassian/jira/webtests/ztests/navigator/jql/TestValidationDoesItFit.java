...
public class TestValidationDoesItFit extends AbstractJqlFuncTest
{
    ...
    {
        // filter 10000: "issuetype in subTaskIssueTypes()" but sub tasks are disable so invalid
        navigation.issueNavigator().loadFilter(10000, IssueNavigatorNavigation.NavigatorEditMode.SIMPLE);
        assertEquals(navigation.issueNavigator().getCurrentMode(), IssueNavigatorNavigation.NavigatorMode.EDIT);
