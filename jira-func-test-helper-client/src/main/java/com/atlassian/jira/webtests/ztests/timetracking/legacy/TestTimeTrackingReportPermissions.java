...
public class TestTimeTrackingReportPermissions extends JIRAWebTest
{
    ...
    public TestTimeTrackingReportPermissions(String name)
    {
        super(name);
    }
    ...
    Table getTable(String id)
    {
        try
        {
            return new Table(getDialog().getResponse().getTableWithID(id));
        }
    ...
    private class Table
    {
        ...
        Row nextRow()
        {
            return new Row(getTableRowAsList(table, nextRow++));
        }
    ...
    private class Row extends Assert
    {
        ...
        {
            this(getTableRowAsList(table, rowNum));
        }
