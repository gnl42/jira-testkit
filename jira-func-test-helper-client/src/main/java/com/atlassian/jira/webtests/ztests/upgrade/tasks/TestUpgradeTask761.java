...
public class TestUpgradeTask761 extends FuncTestCase
{
    private static class Backups
    {
        private static class InactiveWorkflowDrafts
        {
    ...
    {
        administration.restoreDataWithBuildNumber(Backups.InactiveWorkflowDrafts.Present.SHORT_WORKFLOW_NAME, 700);
    ...
    public void testNameOfTheADraftCopyDoesNotExceedTheMaxNumberOfAllowedCharsWhenTheNameOfTheParentContainsTheMaxNumberOfAllowedChars()
    {
        ...
        administration.restoreDataWithBuildNumber(Backups.InactiveWorkflowDrafts.Present.LONG_WORKFLOW_NAME, 700);
    ...
    public void testNameOfTheADraftCopyDoesNotExceedTheMaxNumberOfAllowedCharsWhenTheNameOfTheParentContainsTheMaxNumberOfAllowedCharsAndACopyOfTheParentAlsoExists()
    {
        ...
        administration.restoreDataWithBuildNumber
                (
                        Backups.InactiveWorkflowDrafts.Present.LONG_WORKFLOW_NAME_AND_COPY_PRESENT,
                        700
                );
