...
public class TestUserProfile extends FuncTestCase
{
    ...
    {
        administration.restoreBlankInstance(); // required because of the testUserChangePassword
        super.tearDownTest();
    }
    ...
    public void testUserChangePassword()
    {
        ...
        assertEquals(ADMIN_FULLNAME, locator.xpath("//li[@id='header-details-user']/a").getText());
    }
