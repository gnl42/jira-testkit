...
public class TestUserProperties extends JIRAWebTest
{
    ...
    public void testDuplicateProperty()
    {
        ...
        assertions.getJiraFormAssertions().assertFieldErrMsg("This 'key' already exists for the user.");
    }
    ...
    {
        addBobProperty("testprop!", "testvalue");
        assertions.getJiraFormAssertions().assertFieldErrMsg("The 'key' can only contain alphanumeric characters");
    }

    public void testKeyExceedsCharacterLengthCheck()
    {
        addBobProperty(StringUtils.repeat("x", 251), "testvalue");
        assertions.getJiraFormAssertions().assertFieldErrMsg("The 'key' length must be less than 200 characters");
    ...
    public void testValueExceedCharacterLengthCheck()
    {
        ...
        assertions.getJiraFormAssertions().assertFieldErrMsg("The 'value' length must be less than 250 characters"); ;
    }

    public void testKeyIsEmptyCheck()
    {
        addBobProperty("", "testvalue");
        assertions.getJiraFormAssertions().assertFieldErrMsg("The 'key' cannot be empty");
    }

    public void testValueIsEmptyCheck()
    {
        addBobProperty("testproperty", "");
        assertions.getJiraFormAssertions().assertFieldErrMsg("The 'value' cannot be empty");
    }
