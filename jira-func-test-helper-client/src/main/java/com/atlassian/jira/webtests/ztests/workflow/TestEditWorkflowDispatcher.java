...
public class TestEditWorkflowDispatcher extends FuncTestCase
{
    ...
    public void testEditWorkflowDispatcherWithActiveWorkflow()
    {
        ...
        Integer workflowSchemeId = administration.workflowSchemes().goTo().addWorkflowScheme(WORKFLOW_SCHEME_NAME, "");
        administration.workflowSchemes().goTo().assignWorkflowToAllIssueTypes(workflowSchemeId.toString(), ACTIVE_WORKFLOW);
