...
public class TestWorkFlowSchemes extends JIRAWebTest
{
    ...
    public void testAddWorkflowToActiveScheme()
    {
        ...
        navigation.gotoPage("secure/admin/AddWorkflowSchemeEntity!default.jspa?schemeId=10000");

        tester.setWorkingForm("assign-workflow-scheme");
        tester.submit("Assign");

        assertTextPresent("The &quot;"+WORKFLOW_SCHEME+"&quot; workflow scheme is active therefore you cannot change its workflows.");
    }
    ...
    public void testDeleteWorkflowFromActiveScheme()
    {
        ...
        navigation.gotoPage("secure/admin/DeleteWorkflowSchemeEntity!default.jspa?schemeId=10000&id=10000");

        tester.setWorkingForm("delete-workflow-scheme-entity");
