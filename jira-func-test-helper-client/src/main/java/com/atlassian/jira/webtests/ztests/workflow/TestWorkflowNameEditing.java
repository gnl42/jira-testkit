...
public class TestWorkflowNameEditing extends JIRAWebTest
{
    ...
    public void testEditInactiveWorkflowWithScheme() throws SAXException
    {
        ...
        tester.gotoPage("/secure/admin/EditWorkflowSchemeEntities!default.jspa?schemeId=10001");
        ...
        tester.gotoPage("/secure/admin/EditWorkflowSchemeEntities!default.jspa?schemeId=10010");
        assertLinkWithTextUrlContains("edited with a scheme", new String[] { "secure/admin/workflows/ViewWorkflowSteps.jspa", "workflowMode=live", "workflowName=edited+with+a+scheme" });
        tester.assertTextNotPresent("editable workflow");
