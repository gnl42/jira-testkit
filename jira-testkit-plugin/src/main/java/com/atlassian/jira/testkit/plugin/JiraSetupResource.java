...
public class JiraSetupResource
{
                             ...
                             LifecycleManager lifecycleManager)
    {
        ...
        this.licenseService = ComponentManager.getComponentInstanceOfType(JiraLicenseUpdaterService.class);
        this.restarter = ComponentManager.getComponentInstanceOfType(JiraSystemRestarter.class);
        this.userService = userService;
        this.dataImportService = ComponentManager.getComponentInstanceOfType(DataImportService.class);
