...
public class ProjectBackdoor {
    ...
    private ProjectCreationData createProjectCreationData(String name, String key, String lead, String projectTypeKey, String projectTemplateKey, String description) {
        ProjectCreationData.Builder projectCreationData = new ProjectCreationData.Builder()
                .withName(name)
                .withKey(key)
                .withDescription(StringUtils.isBlank(description) ? "This project is awesome" : description)
    ...
    private ApplicationUser getUserWithAdminPermission() {
        return userUtil.getUser("admin");
    }
